...
import dependency_injector.providers as provs

_providers = {
    'singleton': provs.Singleton,
    'safe_singleton': provs.ThreadSafeSingleton,
    'local_singleton': provs.ThreadLocalSingleton
}
